      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead><tr className="bg-gray-50 border-b border-gray-100">
                    ...
                    <th className="text-left px-5 py-3 font-semibold text-gray-600 text-xs uppercase">Contact</th>
                  </tr></thead>
                  <tbody>
                    {filteredOrders.length === 0 ? (
                      <tr><td colSpan={9} className="px-5 py-8 text-center text-gray-400">No orders found</td></tr>
        ...
        {activeTab === "analytics" && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              <h3 className="font-semibold text-gray-800 mb-4">Price Distribution</h3>
              <div className="space-y-3">
                {priceRanges.map((r) => (
                  <div key={r.l} className="flex items-center gap-3">
                    <span className="text-sm text-gray-600 w-28">{r.l}</span>
                    <div className="flex-1 bg-gray-100 rounded-full h-2.5">
                      <div className="bg-[#C9A96E] h-2.5 rounded-full" style={{ width: `${(r.count / products.length) * 100}%`, minWidth: r.count > 0 ? "8px" : "0" }} />
                    </div>
