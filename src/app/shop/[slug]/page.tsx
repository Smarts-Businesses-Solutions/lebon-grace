  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10">
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-bone border-t border-rule px-4 py-3 flex items-center gap-3 shadow-lg">
        ...
        <button onClick={handleAddToCart} disabled={product.stock === 0} className={`px-6 py-3 text-sm tracking-wide transition-colors disabled:opacity-50 ${added ? "bg-sage text-paper" : "bg-ink text-paper hover:bg-sand-dark"}`}>
