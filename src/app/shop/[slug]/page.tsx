  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
        ...
        <div className="lg:col-span-4 flex flex-col">
          ...
          <div className="flex items-center gap-2 mb-2">
            <span className="px-2 py-0.5 bg-[#5F7355]/10 text-[#5F7355] text-[11px] font-medium rounded-full">In Stock</span>
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <button
              ...
              className={`w-full py-3.5 text-sm font-semibold tracking-wide rounded-xl transition-all ${added ? "bg-[#23201C] text-white scale-[1.02]" : "bg-[#23201C] text-white hover:bg-[#A8874D] active:scale-[0.98]"}`}
            >
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-200 px-4 py-3 flex items-center gap-3 shadow-lg">
        ...
        <button onClick={handleAddToCart} disabled={product.stock === 0} className="px-6 py-2.5 bg-[#23201C] text-white text-sm font-semibold rounded-lg hover:bg-[#A8874D] transition-colors disabled:opacity-50">
