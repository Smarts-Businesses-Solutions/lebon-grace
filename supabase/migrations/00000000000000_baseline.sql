...
CREATE TABLE public.product_variants (
    ...
    variant_image text DEFAULT ''::text,
    variant_color text,
    variant_size text,
...
--
-- Name: product_variants product_variants_product_slug_variant_sku_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product_variants
    ADD CONSTRAINT product_variants_product_slug_variant_sku_key UNIQUE (product_slug, variant_sku);
...
--
-- Name: products Allow all write; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: products Allow public read; Type: POLICY; Schema: public; Owner: -
--
...
CREATE POLICY product_variants_read ON public.product_variants FOR SELECT TO authenticated, anon USING (true);
